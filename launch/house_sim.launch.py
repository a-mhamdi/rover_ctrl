...
def generate_launch_description():
    ...
    pkg_share = get_package_share_directory('rover_ctrl')

    # Define file and folder paths
    default_model_path = os.path.join(
        pkg_share, 'description/rover.urdf.xacro')
    robot_localization_file_path = os.path.join(
        pkg_share, 'params/ekf.yaml')
    default_rviz_config_path = os.path.join(
        pkg_share, 'config/nav2_config.rviz')

    world_path = os.path.join(
        pkg_share, 'worlds', 'house.world')
    ...
    static_tf_pub_map_to_odom = Node(
        ...
        # Replace with your transform values
    ...
    #   and publish the 3D pose of each link.
